...
import calendarPurple from "../../assets/images/Calender_purple.svg";
...
import BtnSubmit from "../../components/btnOutlined/btnSubmit.jsx";

const EventDetails = () => {
    return (
        <>
            <h2>
                Hier sieht man die Details übers Event und die host profile Card
            </h2>
        </>
    );
};
