...
const NearbyEvents = ({ selectedLocation, userProfileInfo, authorization }) => {
...
const navigateToDetails = (id) => {
    ...
    return (
        <div className="NearbyEventsContainer">
            <article className="NearbyEventsSingleEventContainer" key={filteredEvents[0]?._id}>
                ...
                {settingBookmak1 === BookmarkFull ? (
                    ...
                    <img onClick={() => navigateToDetails(filteredEvents[0]?._id)} className="EventImage" src={filteredEvents[0]?.eventPicURL ? `${backendUrl}/download/${filteredEvents[0].eventPicURL}` : defaultPicEvent1} alt="" />
                ...
                <div onClick={() => navigateToDetails(filteredEvents[0]?._id)} className="EventCardBottomDetailsContainer">
                    ...
                    <img className="RegisteredUserFirstImage" src={filteredEvents[0]?.registeredGuests[0]?.profilePicURL ? `${backendUrl}/download/${filteredEvents[0]?.registeredGuests[0].profilePicURL}` : defaultProfilePic} alt="" />
                        ...
                        <p className="RegisteredUserAmout">{filteredEvents[0]?.registeredGuests.length > 99 ? '99+' : filteredEvents[0]?.registeredGuests.length}</p>
                    </div>
            ...
            <article className="NearbyEventsSingleEventContainer" key={filteredEvents[1]?._id}>
                <div className="ImageAndIconContainer">
                {settingBookmak2 === BookmarkFull ? (
                        <img
                            ...
                            alt="fullBookmark"
                            className="BookmarkIcon"
                            onClick={() => removeEventFromWishlist(filteredEvents[1]._id, 1)}
                        />
                    ) : (
                        <img
                            src={BookmarkEmpty}
                            alt="emptyBookmark"
                            className="BookmarkIcon"
                            onClick={() => addEventToWishlist(filteredEvents[1]._id, 1)}
                        />
                    )}                    
                ...
                <div onClick={() => navigateToDetails(filteredEvents[1]?._id)} className="EventCardBottomDetailsContainer">
                    ...
                    <img className="RegisteredUserFirstImage" src={filteredEvents[1]?.registeredGuests[0]?.profilePicURL ? `${backendUrl}/download/${filteredEvents[1]?.registeredGuests[0].profilePicURL}` : defaultProfilePic} alt="" />
                        ...
                        <p className="RegisteredUserAmout">{filteredEvents[1]?.registeredGuests.length > 99 ? '99+' : filteredEvents[1]?.registeredGuests.length}</p>
                    </div>
                    <div className="LocationInfo">
                        <img className="LocationPinIcon" src={LocationIcon} alt="" />
            ...
            <article className="NearbyEventsSingleEventContainer" key={filteredEvents[2]?._id}>
                <div className="ImageAndIconContainer">
                {settingBookmak3 === BookmarkFull ? (
                        <img
                            ...
                            alt="fullBookmark"
                            className="BookmarkIcon"
                            onClick={() => removeEventFromWishlist(filteredEvents[2]._id, 1)}
                        />
                    ) : (
                        <img
                            src={BookmarkEmpty}
                            alt="emptyBookmark"
                            className="BookmarkIcon"
                            onClick={() => addEventToWishlist(filteredEvents[2]._id, 1)}
                        />
                    )}                    
                ...
                <div onClick={() => navigateToDetails(filteredEvents[2]?._id)} className="EventCardBottomDetailsContainer">
                    ...
                    <img className="RegisteredUserFirstImage" src={filteredEvents[2]?.registeredGuests[0]?.profilePicURL ? `${backendUrl}/download/${filteredEvents[2]?.registeredGuests[0].profilePicURL}` : defaultProfilePic} alt="" />
                        ...
                        <p className="RegisteredUserAmout">{filteredEvents[2]?.registeredGuests.length > 99 ? '99+' : filteredEvents[2]?.registeredGuests.length}</p>
                    </div>
                    <div className="LocationInfo">
                        <img className="LocationPinIcon" src={LocationIcon} alt="" />
